...
#import "BaseBadgeButton.h"

@interface BaseTabBarButton()
/**
 *  提醒数字
 */
@property (nonatomic, weak) BaseBadgeButton *badgeButton;
@end
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setTitleColor:iOS7 ? IWColor(234, 103, 7) : IWColor(248, 139, 0) forState:UIControlStateSelected];
        ...
        // 添加一个提醒数字按钮
        BaseBadgeButton *badgeButton = [[BaseBadgeButton alloc] init];
